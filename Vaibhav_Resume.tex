...
\begin{center}
  ...
  \quad\faLinkedin\enspace\href{https://linkedin.com/in/vaibhavraheja}{Linkedin}
  \quad\faLink\enspace\href{https://vaibhavraheja.com}{Portfolio}
  \quad\faGithub\enspace\href{https://github.com/vaibhavraheja}{Github}
\end{center}

%--- PROFESSIONAL SUMMARY ----------------------------------------------------
\section{Professional Summary}
Robotics Systems Engineer with 2+ years building and deploying autonomous platforms across hardware-software architecture, multi-sensor perception, and production field operations. Strong across ROS2-based autonomy, multi-sensor fusion (LiDAR, thermal, PTZ), and full-stack robotics infrastructure, with field-proven results achieving 90\% uptime and 40\% improvement in fault detection rates.
...
\begin{itemize}[leftmargin=1.2em, topsep=2pt, itemsep=0pt, parsep=0pt]
  ...
  \item Validated sensor performance in extreme thermal conditions (43--46°C) across multiple solar farm field deployments.
  \item Hardened safety-critical motion control and telemetry by shipping 35+ PRs across the C++ and Python robotics stack.
  \item Enabled low-latency remote monitoring via an AWS Kinesis WebRTC teleoperation proof of concept.
  \item Integrated multi-sensor perception stacks (Hesai/Unitree LiDAR, PTZ cameras, Seek thermal) into production via ROS2 and Docker.
\end{itemize}
...
\begin{itemize}[leftmargin=1.2em, topsep=2pt, itemsep=0pt, parsep=0pt]
  ...
  \item Validated RL controller performance by deploying ``Walk These Ways'' on a physical Go1 across grass, gravel, and inclines.
\end{itemize}
